...
public class LoadJsonArray {
    String fileName;
    ArrayList<JSONObject>jsonList;
    ArrayList<String>methodList;
    ArrayList<String>commentList;

    private void addToArray(JSONObject jObject){
        if(jObject.has("code")) {
    ...
    public LoadJsonArray(String fileName){
        //wholeJson="";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(new File(fileName)))) {
            ...
            jsonArray.forEach( obj -> addToArray( (JSONObject) obj ) );
        } catch (Exception e) {
            e.printStackTrace();
        }
